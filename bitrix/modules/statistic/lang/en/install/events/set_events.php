<?
$MESS ['STATISTIC_ACTIVITY_EXCEEDING_NAME'] = "Visitor activity limit exceeding";
$MESS ['STATISTIC_ACTIVITY_EXCEEDING_DESC'] = "
#ACTIVITY_TIME_LIMIT# - test time period (sec.)
#ACTIVITY_HITS# - amount of hits for test time period
#ACTIVITY_HITS_LIMIT# - max of hits for test time period
...
#SERACHER_ID# - searcher ID
#SEARCHER_NAME# - searcher name
#SEARCHER_LINK# - link to searcher hits list
...
$MESS ['STATISTIC_DAILY_REPORT_DESC'] = "
#EMAIL_TO# - site administrator email
...
$MESS ['STATISTIC_DAILY_REPORT_MESSAGE'] = "
#HTML_HEADER#
...
#HTML_FOOTER#
";
$MESS ['STATISTIC_ACTIVITY_EXCEEDING_SUBJECT'] = "#SERVER_NAME#: Activity limit exceeding";
$MESS ['STATISTIC_ACTIVITY_EXCEEDING_MESSAGE'] = "
Activity limit was exceeded by visitor on the site #SERVER_NAME#.
...
>===============================================================
Use the following link for adding to the stop list:
http://#SERVER_NAME##STOPLIST_LINK#
Use the following link for viewing the session:
http://#SERVER_NAME##SESSION_LINK#
Use the following link for viewing visitor profile:
http://#SERVER_NAME##VISITOR_LINK#
Use the following link for viewing searcher hits:
