...
class CAllStatistics extends CKeepStatistics
{
	...
	function StartBuffer()
	{
		...
		if ($STAT_RIGHT>="R")
		{
			...
			$arButtons[] = array(
				...
				"ACTION" => "jsUtils.Redirect(arguments, '".CUtil::JSEscape($APPLICATION->GetCurPageParam($add, array("show_link_stat")))."')",
			);
		}
		if(count($arButtons) > 0)
		{
			$APPLICATION->AddPanelButton(array(
				"SRC" => "/bitrix/images/statistic/icons/stat.gif",
	...
	{
		$err_mess = "File: ".__FILE__."<br>Line: ";
		global $DB, $APPLICATION, $arHashLink;
	...
	///////////////////////////////////////////////////////////////////
	// Запоминаем поисковую фразу при локальном поиске
	///////////////////////////////////////////////////////////////////
	...
	{
		$err_mess = "File: ".__FILE__."<br>Line: ";
		global $DB, $INC_GUESTS_BACK_COUNTER;
	...
	function Set_Guest()
	{
		...
		global $DB, $USER, $APPLICATION, $SESS_AUTH, $INC_GUESTS_BACK_COUNTER, $last_referer1, $last_referer2;
