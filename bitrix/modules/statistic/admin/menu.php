...
if($APPLICATION->GetGroupRight("statistic")!="D")
{
	$aMenu = Array(
		array(
		...
		array(
			...
			"items" => array(
				...
				Array(
					...
					"items_id" => "menu_statistic_phras2",
					"items" => array(
						Array(
							...
							"title" => "",
							"more_url" => Array(
								"phrase_list.php?group_by=P",
							),
						),
						Array(
							"text" => GetMessage("STATM_INT_SEARCH"),
							"url" => "phrase_list.php?lang=".LANGUAGE_ID.'&amp;group_by=none&amp;find_searcher_id=1&amp;find_searcher_exact_match=Y&amp;set_filter=Y',
							"more_url" => Array(
								"phrase_list.php?group_by=none&find_searcher_id=1&find_searcher_exact_match=Y",
								"phrase_list.php?group_by=none&find_searcher_id=1&find_searcher_id_exact_match=Y",
							),
							"title" => "",
						),
					),
		...
		Array(
			...
			"items" => array(
				...
				Array(
					...
					"more_url"=>array("referer_list.php?group_by=none"),
				),
			)
		),
		array(
