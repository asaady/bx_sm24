...
<table border="0" cellspacing="1" cellpadding="1" class="list">
	...
	<tr>
		...
		<td><a target="_blank" href="<?echo $f_URL_FROM?>"><?echo InsertSpaces($f_URL_FROM,30,"<wbr>")?></a>&nbsp;</td>
	</tr>
	<tr>
		<td valign="top" nowrap>
			<?echo GetMessage("STAT_PAGE")?></td>
		<td><?if (strlen($f_SITE_ID)>0):?>[<a title="<?=GetMessage("STAT_SITE")?>" href="/bitrix/admin/site_edit.php?LID=<?=$f_SITE_ID?>&lang=<?=LANGUAGE_ID?>"><?=$f_SITE_ID?></a>]&nbsp;<?endif;?><a target="_blank" href="<?echo $f_URL?>"><span class="<?echo ($f_URL_404=="Y") ? "stat_attention" : ""?>"><?echo InsertSpaces($f_URL,40,"<wbr>")?></span></a></td>
	</tr>
	<tr>
		<td valign="top" nowrap>
