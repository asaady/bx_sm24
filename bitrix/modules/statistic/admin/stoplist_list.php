...
if(	AdminListCheckDate($lAdmin, array("find_date_start_1"=>$find_date_start_1, "find_date_start_2"=>$find_date_start_2)) &&
...
while($arRes = $rsData->NavNext(true, "f_"))
{
	...
	if (strlen($f_URL_FROM) > 0)
	{
		if (strlen($f_URL_FROM) >=55)
		{
			...
			$str = '<a href="'.$f_URL_FROM.'">'.$uri_type.'://'.substr($stripped, 0, 30).'...'.substr($stripped, -10).'</a>';
		}
		else
		{
			$str = '<a href="'.$f_URL_FROM.'">'.$f_URL_FROM.'</a>';
		}
	...
	if (strlen($f_URL_TO) > 0)
	{
		if (strlen($f_URL_TO) >=55)
		{
			...
			$str = '<a href="'.$f_URL_TO.'">'.$uri_type.'://'.substr($stripped, 0, 30).'...'.substr($stripped, -10).'</a>';
		}
		else
		{
			$str = '<a href="'.$f_URL_TO.'">'.$f_URL_TO.'</a>';
		}
