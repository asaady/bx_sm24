...
<table border="0" cellspacing="1" cellpadding="1" class="list">
	...
	<tr>
		...
		<td>&nbsp;<a target="_blank" href="<?echo $f_URL_FROM?>" ><?echo InsertSpaces($f_URL_FROM,70,"<wbr>")?></a></td>
	</tr>
	<tr>
		<td valign="top" nowrap><?echo GetMessage("STAT_URL_TO")?></td>
		<td><?if (strlen($f_FIRST_SITE_ID)>0):?>[<a title="<?=GetMessage("STAT_SITE")?>" href="/bitrix/admin/site_edit.php?LID=<?=$f_FIRST_SITE_ID?>&lang=<?=LANGUAGE_ID?>"><?=$f_FIRST_SITE_ID?></a>]&nbsp;<?endif;?>&nbsp;<a target="_blank" href="<?echo $f_URL_TO?>"><span class="<?echo ($f_URL_TO_404=="Y") ? "stat_attention" : ""?>"><?echo InsertSpaces($f_URL_TO,40,"<wbr>")?></span></a></td>
	</tr>
	<tr>
		<td valign="top" nowrap><?echo GetMessage("STAT_LAST_PAGE")?></td>
		<td><?if (strlen($f_LAST_SITE_ID)>0):?>[<a title="<?=GetMessage("STAT_SITE")?>" href="/bitrix/admin/site_edit.php?LID=<?=$f_LAST_SITE_ID?>&lang=<?=LANGUAGE_ID?>"><?=$f_LAST_SITE_ID?></a>]&nbsp;<?endif;?>&nbsp;<a target="_blank" href="<?echo $f_URL_LAST?>"><font class="<?echo ($f_URL_LAST_404=="Y") ? "attention" : ""?>"><?echo InsertSpaces($f_URL_LAST,40,"<wbr>")?></a></td>
	</tr>
	<tr>
