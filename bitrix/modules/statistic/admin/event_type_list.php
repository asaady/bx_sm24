...
while($arRes = $rsData->NavNext(true, "f_")):
	...
	if($f_TODAY_COUNTER>0):
		...
		if($f_TODAY_MONEY>0 && $STAT_RIGHT>"M"):
			$strHTML.=" (".number_format($f_TODAY_MONEY, 2, ".", "\xA0").")";
		endif;
	else:
		$strHTML='&nbsp;';
	endif;
	...
	if($f_YESTERDAY_COUNTER>0):
		...
		if($f_YESTERDAY_MONEY>0 && $STAT_RIGHT>"M"):
			$strHTML.=" (".number_format($f_YESTERDAY_MONEY, 2, ".", "\xA0").")";
		endif;
	else:
		$strHTML='&nbsp;';
	endif;
	...
	if($f_B_YESTERDAY_COUNTER>0):
		...
		if($f_B_YESTERDAY_MONEY>0 && $STAT_RIGHT>"M"):
			$strHTML.=" (".number_format($f_B_YESTERDAY_MONEY, 2, ".", "\xA0").")";
		endif;
	else:
		$strHTML='&nbsp;';
	endif;
	...
	if($bIsPeriod):
		if($f_PERIOD_COUNTER>0):
			...
			if($f_PERIOD_MONEY>0 && $STAT_RIGHT>"M"):
				$strHTML.=" (".number_format($f_PERIOD_MONEY, 2, ".", "\xA0").")";
			endif;
		else:
			$strHTML='&nbsp;';
		endif;
	...
	if($f_TOTAL_COUNTER>0):
		...
		if($f_TOTAL_MONEY>0 && $STAT_RIGHT>"M"):
			$strHTML.=" (".number_format($f_TOTAL_MONEY, 2, ".", "\xA0").")";
		endif;
	else:
		$strHTML='&nbsp;';
	endif;
...
$arFooter[] = array(
	...
	"value"=>$arTotal["TODAY_COUNTER"].($STAT_RIGHT>"M" && $arTotal["TODAY_MONEY"]>0?"(".number_format($arTotal["TODAY_MONEY"], 2, ".", "\xA0").")":""),
	);
$arFooter[] = array(
	"title"=>GetMessage("STAT_YESTERDAY_EVENTS"),
	"value"=>$arTotal["YESTERDAY_COUNTER"].($STAT_RIGHT>"M" && $arTotal["YESTERDAY_MONEY"]>0?"(".number_format($arTotal["YESTERDAY_MONEY"], 2, ".", "\xA0").")":""),
	);
$arFooter[] = array(
	"title"=>GetMessage("STAT_B_YESTERDAY_EVENTS"),
	"value"=>$arTotal["B_YESTERDAY_COUNTER"].($STAT_RIGHT>"M" && $arTotal["B_YESTERDAY_MONEY"]>0?"(".number_format($arTotal["B_YESTERDAY_MONEY"], 2, ".", "\xA0").")":""),
	);
if($bIsPeriod)
	$arFooter[] = array(
		"title"=>GetMessage("STAT_PERIOD_EVENTS"),
		"value"=>$arTotal["PERIOD_COUNTER"].($STAT_RIGHT>"M" && $arTotal["PERIOD_MONEY"]>0?"(".number_format($arTotal["PERIOD_MONEY"], 2, ".", "\xA0").")":""),
		);
$arFooter[] = array(
	"title"=>GetMessage("STAT_TOTAL_EVENTS"),
	"value"=>$arTotal["TOTAL_COUNTER"].($STAT_RIGHT>"M" && $arTotal["TOTAL_MONEY"]>0?"(".number_format($arTotal["TOTAL_MONEY"], 2, ".", "\xA0").")":""),
	);
...
$aContext[] =
	array(
		...
		"MENU"=>array(
			...
			array(
				"TEXT"=>GetMessage("STAT_EVENT2 GROUP"),
