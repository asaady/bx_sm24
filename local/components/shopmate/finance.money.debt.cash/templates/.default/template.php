...
<table class="table table-hover mb30">
	<thead>
		<tr>
			...
			<th><a href="<?=$arResult["SORTS"]["MEMBERS"]["URL"]?>">Кто нам должен</a></th>
			<th><a href="<?=$arResult["SORTS"]["SUMM"]["URL"]?>">Сумма</a></th>
			<th><a href="<?=$arResult["SORTS"]["REASON"]["URL"]?>">Чек</a></th>
			<th><a href="<?=$arResult["SORTS"]["TOTAL_SUMM"]["URL"]?>">Общая сумма чека</a></th>
