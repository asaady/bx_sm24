...
<?endif?>
	...
	<div class=" mb30">
		<?if (\Yadadya\Shopmate\Rights::GetUserPermission("useroverhead") >= "R"):?>
			<?global $arrUserOverheadFilter;
			$arrUserOverheadFilter = ["OVERHEAD_ID" => false];?>
			<?$APPLICATION->IncludeComponent("shopmate:user.overhead.list", "", ["NAV_ON_PAGE" => false, "FILTER_NAME" => "arrUserOverheadFilter", "EDIT_URL" => $APPLICATION->GetCurDir()."?inbox=Y"]);?>
			<hr />
		<?endif?>
