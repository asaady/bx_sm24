...
<div class="panel panel-body">
	<form action="<?=POST_FORM_ACTION_URI?>" method="post" id="fabrica_form" class="form-horizontal save_alert fabrica_form" autocomplete="off">
	...
	<?endif?>
		<div id="halfviz" style="height: 300px; margin: 3px; border: 3px solid; padding: 10px;">
		...
		<?foreach($arResult["ITEM"][$propertyID] as $arItem):
			$arItem["CONNECT"][] = array("SAMPLE" => "Y", "ID" => "new_id");?>
			<div class="modal fade form-group fabrica_form__item<?if($arItem["SAMPLE"] == "Y"):?> fabrica_form__item__sample<?endif?> deleted_block<?/* load_info*/?>" data-item="<?=$arItem["ID"]?>" style="display:none;">
				<div class="modal-dialog modal-lg">
					<div class="modal-content">
						...
						<div class="modal-body">
							...
							<table class="table mb30" style="position: absolute; top: 191px; width: calc(100% - 30px);">
								<tr>
									<td class="col-sm-3">
		...
		<br>
		<div class="alert alert-info">для редактирования нажмите на плавающий элемент</div>
